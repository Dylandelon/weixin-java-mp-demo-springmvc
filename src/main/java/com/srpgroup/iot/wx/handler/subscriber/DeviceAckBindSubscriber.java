...
@Component
public class DeviceAckBindSubscriber extends Subcriber<WxDeviceBind>{
    public DeviceAckBindSubscriber(WeixinService wxService) {
        super(wxService);
    }
    ...
    public void handle(String deviceId, WxDeviceBind wxDeviceBind) throws WxErrorException {
        //TODO 状态更新进数据库
//        wxService.getDeviceService().compelBind(wxDeviceBind);
    }
}
